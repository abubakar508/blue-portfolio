  ...
  return <div>
    ...
    <section className="Skillrank">
        <div className="skill-rank-cont">
            <Link to="/Skills" title="Previous Page" className="skill-link"><GrArchlinux className="skill-rank-icon"/>  Go Back to Skills</Link>
            <h2>Proffesional Skills by Percentage<span>.</span></h2>
            ...
            <div className="skill-rank-item">
                <span>UI/UX Design :
                <BiLogoFigma className="skill-icons" /></span>
<div className="skills-bar-1">
                </div>
                <div className="skill-rank-item">
                <span>Backend :<IoLogoNodejs className="skill-icons" /></span>
<div className="skills-bar-4">
            ...
            <div className="skill-rank-item">
              ...
              <SiEthereum className="skill-icons" /></span>
<div className="skills-bar-2">
            ...
            <div className="skill-rank-item">
              ...
              <SiQuickbooks className="skill-icons" /></span>
...
<div className="skills-bar-5">
            ...
            <div className="skill-rank-item">
                <span>WEB3 :<SiWeb3Dotjs /></span>
<div className="skills-bar-6">
                </div>
